...
if args.mode == 'train':
    ...
    dqn.fit(env, callbacks=callbacks, visualize=False, nb_steps=10000000, log_interval=50000)
    ...
    dqn.test(env, nb_episodes=10, visualize=True, nb_max_episode_steps=5000)